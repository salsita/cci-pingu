...
// + unless started with "prefixed = false"
...
//
// Interface:
// + install(level = null, name = null, prefixed = true)
//       Set new console handlers:
//       - level: 'log' || 'info' (default) || 'warn' || 'error'
//       - name:  any string (not set by default)
//       - prefixed: if true (default), print timestamp, app name and log-level as part of the message
